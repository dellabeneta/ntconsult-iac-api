...
| [digitalocean_database_db.api_db](https://registry.terraform.io/providers/digitalocean/digitalocean/2.36.0/docs/resources/database_db) | resource |
...
| [digitalocean_database_user.api_user](https://registry.terraform.io/providers/digitalocean/digitalocean/2.36.0/docs/resources/database_user) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_database_api_db"></a> [database\_api\_db](#input\_database\_api\_db) | Base de dados para utilização no ambiente | `string` | `"api-db"` | no |
| <a name="input_database_api_user"></a> [database\_api\_user](#input\_database\_api\_user) | Usuário para utilização da base de dados do ambiente | `string` | `"api-user"` | no |
...
| <a name="input_project_name"></a> [project\_name](#input\_project\_name) | n/a | `string` | `"Main Project"` | no |
