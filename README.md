...
| <a name="input_do_token"></a> [do\_token](#input\_do\_token) | n/a | `string` | `""` | no |
...
| <a name="input_my_ipv4_address"></a> [my\_ipv4\_address](#input\_my\_ipv4\_address) | n/a | `string` | `""` | no |
...
| <a name="input_project_environment"></a> [project\_environment](#input\_project\_environment) | n/a | `string` | `"Production"` | no |
